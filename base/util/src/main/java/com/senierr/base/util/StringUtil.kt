...
object StringUtil {
    ...
    fun upperFirstLetter(s: String): String {
        return if (TextUtils.isEmpty(s) || !Character.isLowerCase(s[0])) s else (s[0].code - 32).toChar() + s.substring(1)
    }
    ...
    fun lowerFirstLetter(s: String): String {
        return if (TextUtils.isEmpty(s) || !Character.isUpperCase(s[0])) s else (s[0].code + 32).toChar() + s.substring(1)
    }
